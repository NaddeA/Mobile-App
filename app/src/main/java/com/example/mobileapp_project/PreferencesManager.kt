...
// This class manages user preferences for the app, allowing you to store and retrieve settings using SharedPreferences.
class PreferencesManager(context: Context) {
    ...
    // Editor instance for writing data to SharedPreferences
